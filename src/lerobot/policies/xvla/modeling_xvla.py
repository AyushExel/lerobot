...
class XVLAModel(nn.Module):
    ...
    def forward_vlm(
        ...
        # XVLA prepends the primary view's image tokens to the text embeddings and attends to
        # everything, reproducing the semantics of the original remote-code
        # `_merge_input_ids_with_image_features` (which ignored text padding on purpose).
